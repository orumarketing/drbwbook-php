		...
		<div class="container col-md-11 col-xl-10">
			<div class="row">
				<div class="col-xl-7">
					<div class="d-flex align-items-center" style="height: 100%">
						<div class="embed-responsive embed-responsive-16by9"> <iframe
								src="https://player.vimeo.com/video/860343455?h=e399b9d131" width="640" height="360"
				...
				<div class="col-xl-5">
					...
					<p>
						Can we mobilize today’s church for collaborative results achieved
						in unprecedented ways? What can one person do to make a
						difference? In <em>The Power of One</em>, Dr. Wilson answers these
						questions with a plan forward through the re-personalization of
						the Great Commission and a renewed focus on the potential of
						everyONE.
					</p>
					<p>
						Reaching one person with the good news of Jesus Christ seems
						insignificant compared to the world’s population. Repeatedly,
						Jesus sought one person, ministered to one person, touched one
						person, healed one person, and saved one person. When we are the
						ONE who has been saved, we are the ONE appointed to find ONE more!
					</p>
					<p>
						A new era of global evangelism is dawning in our post-pandemic,
						fast-moving, 21st-century world. Jesus’ method of reaching one
						person and thus unlocking their capacity to touch the masses is
						being reclaimed. The most significant days of Great Commission
						effort in human history are before us.
					</p>
				</div>
			</div>
		</div>
			...
			<div class="row" data-astro-cid-ddbcycih>
				...
				<div class="col-12 col-md-6 d-flex flex-column justify-content-center" data-astro-cid-ddbcycih>
					<p class="text-center text-light">
						Order <em>The Power of One</em> Today!
					</p>
