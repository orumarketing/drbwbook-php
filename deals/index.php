...
$this_page_book_title = "Book Deals"; // Put the title of whatever is in the hero section
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body id="homepage" class="sections-page">
    ...
    <div class="page-header page-header-small header-filter">
        <div class="page-header-image" style="background: linear-gradient(45deg, #1e0d0d00, #6c6c6c69),
          url(<?php echo $base_url; ?>assets/img/new-images/bundle-program-background.jpg);background-size: cover;background-repeat: no-repeat;">
            <div class="text-center text-uppercase navbottom space-above-hero d-none">
                <p class="navbottom-text">&nbsp;</p>
            </div>
            <div class="container">
                <div class="row align-items-center text-left">
                    <div class="col-lg-7 pl-0"><a href="<?php echo $base_url; ?>father-cry" title="Learn More" target="_blank" data-astro-cid-xvd67bzn>
                        <img class="pop-out-book mr-lg-5" src="<?php echo $base_url; ?>assets/img/new-images/bundle-hero.png" width="100%" alt="Dr. Billy Wilson's Library">
                    </a></div>
                    <div class="col-lg-5 hero">
                        <h1 class="display-3 dark-text order-lg-0">Books Bundle</h1>
                        <p class="lead pb-0 dark-text order-lg-1">Dr. Billy Wilson's Library. All four books for <del>$97.22</del> <em>$60</em>. One powerful collection. Save when you buy the complete set.</p>
                        <div class="my-5">
                        <div class="d-none d-lg-block"> 
                            <a class="btn btn-secondary hero-btn mt-2" href="https://shop.harpandswordmedia.com/a/bundles/dr.-billy-wilsons-library-esr5" target="_blank" data-astro-cid-xvd67bzn>Order Now</a> 
                        </div>
                        <div class="d-lg-none">
                            <a class="btn btn-dark btn-block hero-btn" href="https://shop.harpandswordmedia.com/a/bundles/dr.-billy-wilsons-library-esr5" target="_blank" data-astro-cid-n2irbncb>Order Now</a> 
                        </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="section testimonials team-1 bd-btm-false">
        <div class="container col-md-11 col-xl-10">
            <h3 class="display-3 px-3 mb-3 text-center text-uppercase">More Amazing Offers</h3>
            <div class="row justify-content-center">
                <div class="col-6 p-3 border-top">
                    <h5>Buy Father Cry at full price, get The Power of One for $7.22!</h5>
                </div>
                <div class="col-2 p-3">
                    <a href="https://shop.harpandswordmedia.com/products/father-cry" class="btn btn-secondary" target="_blank" data-astro-cid-so3q4bn5>Link to order</a></p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-6 p-3 border-top">
                    <h5>The Power of One Buy 1, Give 1: Buy The Power of One at full price, get a second copy at half price</h5>
                </div>
                <div class="col-2 p-3">
                    <a href="https://shop.harpandswordmedia.com/products/the-power-of-one" class="btn btn-secondary" target="_blank" data-astro-cid-so3q4bn5>Link to order</a></p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-6 p-3 border-top border-bottom">
                    <h5>The Power of One 10 Pack for $100</h5>
                </div>
                <div class="col-2 p-3">
                    <a href="https://shop.harpandswordmedia.com/products/the-power-of-one" class="btn btn-secondary" target="_blank" data-astro-cid-so3q4bn5>Link to order</a></p>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-6 p-3 border-top border-bottom">
                    <h5>El Poder de Uno 10 Pack for $100</h5>
                </div>
                <div class="col-2 p-3">
                    <a href="https://shop.harpandswordmedia.com/products/el-poder-de-uno" class="btn btn-secondary" target="_blank" data-astro-cid-so3q4bn5>Link to order</a></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-md-6" data-astro-cid-ddbcycih>
                    <div class="d-flex align-items-center justify-content-center" style="height: 100%"
                        ...
                        <h4 class="display-4 text-white mb-0 text-center">
                            Books Bundle<br><em>Dr. Billy Wilson’s Library</em>
                        </h4>
                    </div>
                </div>
                <div class="col-12 col-md-6 d-flex flex-column justify-content-center" data-astro-cid-ddbcycih>
                    <p class="text-center text-light">
                        All four books for <del>$97.22</del> <em>$60</em>
                    </p>
                    <p class="text-center buttons-section"> 
            <a href="https://shop.harpandswordmedia.com/a/bundles/dr.-billy-wilsons-library-esr5" class="btn btn-secondary mt-2" target="_blank" data-astro-cid-so3q4bn5>Order Now</a></p>
                </div>
            </div>
        </div>
    </section>
