...
<head>
	...
	<link href="<?php echo $base_url; ?>assets/css/nucleo-svg.css" rel="stylesheet"><!-- CSS Files -->
	...
	<style>
		...
		:root {
			...
			--testimonial-author: var(--accent-color-one);
		...
		:root {
			--main-color: #121c2c;
			--secondary-color: #009041;
			--accent-color-one: #db8d29
		}

		#born-the-storm-page .navbar,
		#born-the-storm-page .sec-download {
			background-color: var(--cta-background)
		}

		#born-the-storm-page .navbottom {
			background-color: var(--color-white)
		}

		#born-the-storm-page h3 {
			color: var(--main-color)
		}

		#born-the-storm-page .bd-btm,
		#born-the-storm-page .testimony {
			border-color: var(--secondary-tan)
		}
	</style>
</head>

<body id="born-the-storm-page" class="sections-page"> <!-- Google Tag Manager (noscript) --><noscript><iframe
		...
		<div class="container col-md-11 col-xl-10">
			<div class="row">
				<div class="col-xl-7">
					<div class="d-flex align-items-center" style="height: 100%">
						<div class="embed-responsive embed-responsive-16by9"> <iframe
								src="https://www.youtube.com/embed/PexkbF4_pEU" width="640" height="360"
				...
				<div class="col-xl-5">
					...
					<p>Gen Z, consisting of those born from 1995-2012, has officially become the largest generation in
						the world today. They are some of the most creative, driven, entrepreneurial, and
						technologically advanced young people the globe has ever seen. And their future impact on the
						world is inestimable.</p>
					<p>Generation Z is called and equipped to rise above the global storm we are experiencing and
						initiate the greatest awakening our world has ever seen. They are ready. They are willing. They
						are born for the storm.</p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row" data-astro-cid-ddbcycih>
				<div class="col-12 col-md-6" data-astro-cid-ddbcycih>
					<div class="d-flex align-items-center justify-content-center" style="height: 100%"
						...
						<h4 class="display-4 text-white mb-0 text-center">
							Let's Empower Gen Z<br>For The Future
						</h4>
					</div>
				</div>
				<div class="col-12 col-md-6 d-flex flex-column justify-content-center" data-astro-cid-ddbcycih>
					<p class="text-center buttons-section"> <a
							href="https://www.amazon.com/dp/1637630271/ref=redir_mobile_desktop?_encoding=UTF8&#38;qid=1623256685&#38;ref_=tmm_hrd_swatch_0&#38;sr=8-1"
